...
function Counter() {
  ...
  return (
    <div className="counter-app">
      ...
      <div className="counter-menu">
        <button className="button counter-add-button" onClick={() => setCounter(counter + 1)}>
          +
        </button>
        <button className="button counter-subtract-button" onClick={() => setCounter(counter - 1)}>
          -
        </button>
        <button className="button counter-reset-button" onClick={() => setCounter(0)}>
          reset
        </button>
      </div>
    </div>
